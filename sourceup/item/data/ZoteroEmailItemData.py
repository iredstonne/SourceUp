...
class ZoteroEmailItemData(ZoteroBaseItemData):
    subject: Optional[str] = None

    @override
    @classmethod
    def item_type(cls) -> ZoteroItemType:
        return ZoteroItemType.EMAIL
    ...
    def map_from_data(cls, _data: Dict[str, Any]) -> "ZoteroEmailItemData":
        ...
        return cls(
            **{_base_item_data_field.name: getattr(_base_item_data, _base_item_data_field.name)
            ...
            subject=map_to_str(_data.get("subject"))
        )
    ...
    def map_to_bibxml(self, _source_element: Element):
        ...
        # PublicationTitle: Mapped (subject)
        # City: Not mapped
        ...
        add_bibliography_namespaced_element_if_missing(_source_element, "PublicationTitle", self.subject)
